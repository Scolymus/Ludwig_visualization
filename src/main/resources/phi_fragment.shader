...
float colormap_f1(int formula, float x) {
    ...
    if (formula == 0) {
        ...
        d = x * x * x / (phi_max * phi_max * phi_max);
    } else if (formula == 6) {
        d = x * x * x * x;
    } else if (formula == 7) {
        d = sqrt(x)/sqrt(phi_max);
    } else if (formula == 8) {
        d = sqrt(sqrt(x));
    } else if (formula == 9) {
...
void main()
{
    ...
    outColor = vec4(colormap_f1(7, Color), colormap_f1(5, Color), colormap_f1(15, Color), AlphaC);
}
